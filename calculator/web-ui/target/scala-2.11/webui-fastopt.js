...
$c_Lcalculator_Calculator$.prototype.evaluate__Lcalculator_Expr__sci_Map__sci_Set__D = (function(e, references, cyclic) {
  _evaluate: while (true) {
    var x1 = e;
    if ($is_Lcalculator_Literal(x1)) {
      ...
      if (cyclic.contains__O__Z(name)) {
        return (NaN)
      } else if ($s_sc_MapLike$class__contains__sc_MapLike__O__Z(references, name)) {
        var this$11 = $m_s_Console$();
        var this$12 = $as_Ljava_io_PrintStream(this$11.outVar$2.v$1);
        this$12.java$lang$JSConsoleBasedPrintStream$$printString__T__V("HERE\n");
        var temp$e = $as_Lcalculator_Expr($as_Lcalculator_Signal(references.apply__O__O(name)).apply__O());
        var jsx$2 = cyclic;
        var array = [name];
        ...
        var temp$cyclic = $as_sci_Set(jsx$2.$$plus$plus__sc_GenTraversableOnce__sc_Set(jsx$1));
        e = temp$e;
        cyclic = temp$cyclic;
        continue _evaluate
      } else {
      ...
      var a = x4.a$2;
      var b$1 = x4.b$2;
      return (this.evaluate__Lcalculator_Expr__sci_Map__sci_Set__D(a, references, cyclic) + this.evaluate__Lcalculator_Expr__sci_Map__sci_Set__D(b$1, references, cyclic))
    } else if ($is_Lcalculator_Minus(x1)) {
      var x5 = $as_Lcalculator_Minus(x1);
      var a$2 = x5.a$2;
      var b$2 = x5.b$2;
      return (this.evaluate__Lcalculator_Expr__sci_Map__sci_Set__D(a$2, references, cyclic) - this.evaluate__Lcalculator_Expr__sci_Map__sci_Set__D(b$2, references, cyclic))
    } else if ($is_Lcalculator_Times(x1)) {
      var x6 = $as_Lcalculator_Times(x1);
      var a$3 = x6.a$2;
      var b$3 = x6.b$2;
      return (this.evaluate__Lcalculator_Expr__sci_Map__sci_Set__D(a$3, references, cyclic) * this.evaluate__Lcalculator_Expr__sci_Map__sci_Set__D(b$3, references, cyclic))
    } else if ($is_Lcalculator_Divide(x1)) {
      var x7 = $as_Lcalculator_Divide(x1);
      var a$4 = x7.a$2;
      var b$4 = x7.b$2;
      return (this.evaluate__Lcalculator_Expr__sci_Map__sci_Set__D(a$4, references, cyclic) / this.evaluate__Lcalculator_Expr__sci_Map__sci_Set__D(b$4, references, cyclic))
    } else {
      throw new $c_s_MatchError().init___O(x1)
    }
  }
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__T2__T2 = (function(ne) {
  var jsx$5 = ne.$$und1$f;
  $m_Lcalculator_Signal$();
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, ne$1) {
    return (function() {
      var jsx$4 = $m_Lcalculator_Calculator$();
      var jsx$3 = $as_Lcalculator_Expr($as_Lcalculator_Signal(ne$1.$$und2$f).apply__O());
      var jsx$2 = arg$outer.namedExpressions$1$f;
      var array = [$as_T(ne$1.$$und1$f)];
      if (($uI(array.length) === 0)) {
        var jsx$1 = $m_sci_Set$EmptySet$()
      } else {
        var b = new $c_scm_SetBuilder().init___sc_Set($m_sci_Set$EmptySet$());
      ...
      return jsx$4.evaluate__Lcalculator_Expr__sci_Map__sci_Set__D(jsx$3, jsx$2, $as_sci_Set(jsx$1))
    })
  })(this, ne));
  return new $c_T2().init___O__O(jsx$5, new $c_Lcalculator_Signal().init___F0(expr))
});
